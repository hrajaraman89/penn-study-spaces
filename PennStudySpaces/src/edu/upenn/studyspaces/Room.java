...
public class Room implements Serializable {
    ...
    /*
     * private DateFormat df = new SimpleDateFormat("yyyy-MM-dd"); private
     * DateFormat df1 = new SimpleDateFormat("HH"); private DateFormat df2 = new
     * SimpleDateFormat("mm");
     */
    ...
    public boolean getAvailability(int start_time, int end_time, String date)
            throws Exception {
        ...
        if (times.get(1) == JSONObject.NULL) {
            if ((start_time >= start_time_on_date)
                    && (end_time <= end_time_on_date)) {
                return true;
            } else {
                return false;
            }
